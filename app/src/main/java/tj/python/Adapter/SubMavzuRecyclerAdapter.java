...
public class SubMavzuRecyclerAdapter extends RecyclerView.Adapter<SubMavzuRecyclerAdapter.Holder> {
    List<SubMavzu> list;
    Context mctx;

    public SubMavzuRecyclerAdapter(Context mctx, List<SubMavzu> list) {
        this.list = list;
        this.mctx = mctx;
    }
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View item = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_sub_mavzu, viewGroup, false);
